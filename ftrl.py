...
def data(path, D):
    ...
    for t, row in enumerate(DictReader(open(path))):
        ...
        yield t, time, user_id, item_id, x, y
...
for e in xrange(epoch):
    ...
    for t, time, user_id, item_id, x, y in data(train, D):  # data is a generator
...
with open(submission, 'w') as outfile:
    outfile.write('user_id,item_id,click\n')
    for t, time, user_id, item_id, x, y in data(test, D):
        p = learner.predict(x)
        outfile.write('%s,%s,%s\n' % (user_id, item_id, str(p)))